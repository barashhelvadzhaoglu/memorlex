  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-white">
      <div className="max-w-md w-full text-center space-y-8">
        <div>
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Hoş Geldin! 👋</h1>
          <p className="text-slate-500">Hangi dilde pratik yapmak istersin?</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="text-left flex-1 text-slate-800">
              ...
              <p className="text-sm font-medium opacity-60">A1 - A2 SEVİYESİ</p>
            </div>
          </Link>

          {/* İngilizce Kartı - Greyout (Pasif) */}
          <div className="flex items-center p-6 bg-slate-50 border-2 border-slate-50 rounded-3xl opacity-40 cursor-not-allowed">
            ...
            <div className="text-left flex-1 text-slate-400">
              ...
              <p className="text-sm font-medium">ÇOK YAKINDA</p>
            </div>
          </div>
        </div>
      </div>
